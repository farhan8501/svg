...
@Entity
@Table(name = "SOLUTION")
public class Solution_Relevances implements Serializable {
		...
		public boolean equals(Object obj) {
			...
			if (getClass() != obj.getClass())
				return false;
			Solution_Relevances other = (Solution_Relevances) obj;
			if (relevance == null) {
		...
		public String toString() {
			return "Solution_Relevances [solutionid=" + solutionid + ", search_keywords=" + search_keywords
					+ ", relevance=" + relevance + ", solutionlinked=" + solutionlinked + "]";
		}
