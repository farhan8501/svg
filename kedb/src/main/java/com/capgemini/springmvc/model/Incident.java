...
public class Incident implements Serializable{
	...
	public String toString() {
		return "Incident [ticket_id=" + ticket_id + ", ticket_number=" + ticket_number + ", ticket_desc=" + ticket_desc
				+ ", ticket_priority=" + ticket_priority + ", ticket_status=" + ticket_status + ", category_name="
				+ category_name + ", opened_date=" + opened_date + ", closed_date=" + closed_date
				+ ", ratingclassvalue=" + ratingclassvalue + "]";
	}
