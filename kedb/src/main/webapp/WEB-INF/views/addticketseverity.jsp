...
<title>KEDB - Add Ticket Severity </title>
...
<div class="well lead">Add New Ticket Severity Form</div>
		<form:form method="POST" commandName="ticketseverity"  class="form-horizontal">
			<div class="row">
				<div class="form-group col-md-12">
					<label class="col-md-3 control-lable" for="severityname">Severity
						Name</label>
					<div class="col-md-7">
						<form:input type="text" path="severityname" id="severityname"
							class="form-control input-sm" />
						<div class="has-error">
							<form:errors path="severityname" class="help-inline" />
						</div>
					</div>
				</div>
			</div>
