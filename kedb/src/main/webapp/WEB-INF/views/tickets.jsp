...
<head>
    ...
    <script src="static/data/bubble_parameters.js"></script>
...
<div class="col-md-4"><div id="toolbar"></div></div>
 <div class="col-md-3" style="    margin-top: 10px;">
      <input id="search" placeholder="Enter:Ticket Number">
    <button type="button" id="searchButton" class="btn-success">Search</button> 
   
 </div>     
 <div class="col-md-2"> <label id="breadcrumb"></label></div>
</div>
<div class="row">
...
<strong id="incident"></strong>
 ...
 <div class="col-sm-2"style="width: 20.85%"> 
 <div class="row" id="widget1">
 <div class="col-sm-5">
 	<div class="row" style="height:80%"><div id="donut1" class="chart-container scontainer"></div></div>
 	<div class="row" style="height:20%"><a id="link1">Solution<label id="sLabel1"></label></a></div>
 </div>
 <div class="col-sm-5">
 	<div class="row"style="height:60%"><div class="scontainer">Matched:<label id="mLabel1"></label></div></div>
 	<div class="row"style="height:40%">
 		 <div class="col-sm-5"><a id="aLink1"><label id="aLabel1"></label></a></div><br>
 		  <div class="col-sm-5"><button id="like1" class="btn btn-block btn-primary bLike"><i  class="fa fa-thumbs-up"></i></button></div>
 	</div>
 </div>
 </div>
</div>
<div class="col-sm-2"style="width: 20.85%">
 ...
 <div class="col-sm-5">
 	<div class="row" style="height:80%"><div id="donut2" class="chart-container scontainer"></div></div>
 	<div class="row" style="height:20%"><a id="link2">Solution<label id="sLabel2"></label></a></div>
 </div>
 <div class="col-sm-5">
 	<div class="row"style="height:60%"><div class="scontainer">Matched:<label id="mLabel2"></label></div></div>
 	<div class="row"style="height:40%">
 		 <div class="col-sm-5"><a id="aLink2"><label id="aLabel2"></label></a></div>
 		  <div class="col-sm-5"><button id="like2" class="btn btn-block btn-primary bLike"><i  class="fa fa-thumbs-up"></i></button></div>
 	</div>
 </div>
 </div>
</div>
<div class="col-sm-2"style="width: 20.85%">
 ...
 <div class="col-sm-5">
 	<div class="row" style="height:80%"><div id="donut3" class="chart-container scontainer"></div></div>
 	<div class="row" style="height:20%"><a id="link3">Solution<label id="sLabel3"></label></a></div>
 </div>
 <div class="col-sm-5">
 	<div class="row"style="height:60%"><div class="scontainer">Matched:<label id="mLabel3"></label></div></div>
 	<div class="row"style="height:40%">
 		 <div class="col-sm-5"><a id="aLink3"><label id="aLabel3"></label></a></div>
 		  <div class="col-sm-5"><button id="like3" class="btn btn-block btn-primary bLike"><i  class="fa fa-thumbs-up"></i></button></div>
 	</div>
 </div>
 </div>
</div>
<div class="col-sm-2"style="width: 20.85%">
 ...
 <div class="col-sm-5">
 	<div class="row" style="height:80%"><div id="donut4" class="chart-container scontainer"></div></div>
 	<div class="row" style="height:20%"><a id="link4">Solution<label id="sLabel4"></label></a></div>
 </div>
 <div class="col-sm-5">
 	<div class="row"style="height:60%"><div class="scontainer">Matched:<label id="mLabel4"></label></div></div>
 	<div class="row"style="height:40%">
 		 <div class="col-sm-5"><a id="aLink4"><label id="aLabel4"></label></a></div>
 		  <div class="col-sm-5"><button id="like4" class="btn btn-block btn-primary bLike"><i  class="fa fa-thumbs-up"></i></button></div>
 	</div>
 </div>
 </div>
</div>
...
<script src="static/js/bubblesTickets.js"></script>
